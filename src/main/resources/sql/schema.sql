...
CREATE TABLE `strategy_engine` (
  ...
  `applicable_object` varchar(20) NOT NULL COMMENT '适用对象：STUDENT-学生, CLASS-班级, SCHOOL-学校, BUREAU-教育局',
...
-- 固有属性（所有引擎通用）
('kp_name',           '名称',                'INHERENT', 'STRING', '["=","!=","CONTAINS","NOT_CONTAINS"]', '["ALL"]', 1),
('kp_catalog',        '目录',                'INHERENT', 'STRING', '["=","!=","IN","NOT_IN"]',             '["ALL"]', 2),
('kp_stage',          '学段',                'INHERENT', 'ENUM',   '["=","!=","IN","NOT_IN"]',             '["ALL"]', 3),
('kp_course',         '课程',                'INHERENT', 'ENUM',   '["=","!=","IN","NOT_IN"]',             '["ALL"]', 4),
('difficulty_level',  '难度等级',            'INHERENT', 'ENUM',   '["=","!=","IN","NOT_IN"]',             '["ALL"]', 5),
('kp_content_desc',   '内容描述',            'INHERENT', 'STRING', '["=","!=","CONTAINS","NOT_CONTAINS"]', '["ALL"]', 6),
('water_level',       '水平等级',            'INHERENT', 'ENUM',   '["=","!=","IN","NOT_IN"]',             '["ALL"]', 7),
('pre_knowledge',     '前置知识点',          'INHERENT', 'STRING', '["=","!=","CONTAINS","NOT_CONTAINS"]', '["ALL"]', 8),
('post_knowledge',    '后置知识点',          'INHERENT', 'STRING', '["=","!=","CONTAINS","NOT_CONTAINS"]', '["ALL"]', 9),
('out_degree',        '出度',                'INHERENT', 'NUMBER', '[">",">=","<","<=","=","!="]',          '["ALL"]', 10),
('in_degree',         '入度',                'INHERENT', 'NUMBER', '[">",">=","<","<=","=","!="]',          '["ALL"]', 11),
('relevance',         '关联度',              'INHERENT', 'ENUM',   '["=","!=","IN","NOT_IN"]',             '["ALL"]', 12),
('base_property',     '基础性',              'INHERENT', 'ENUM',   '["=","!=","IN","NOT_IN"]',             '["ALL"]', 13),
('exam_count_area',   '知识点考核次数（区域）', 'INHERENT', 'NUMBER', '[">",">=","<","<=","=","!="]',       '["ALL"]', 14),
('exam_score_area',   '知识点考核分数（区域）', 'INHERENT', 'NUMBER', '[">",">=","<","<=","=","!="]',       '["ALL"]', 15),
('importance',        '重要度',              'INHERENT', 'NUMBER', '[">",">=","<","<=","=","!="]',          '["ALL"]', 16),
('importance_area',   '重要度（区域）',       'INHERENT', 'NUMBER', '[">",">=","<","<=","=","!="]',          '["ALL"]', 17),
-- 考试属性（学校、班级、学生，达标占比不含学生）
('exam_mastery',      '考试掌握度',          'EXAM', 'NUMBER', '[">",">=","<","<=","=","!="]', '["SCHOOL","CLASS","STUDENT"]', 1),
('exam_target',       '目标值',              'EXAM', 'NUMBER', '[">",">=","<","<=","=","!="]', '["SCHOOL","CLASS","STUDENT"]', 2),
('exam_reliability',  '可信度',              'EXAM', 'NUMBER', '[">",">=","<","<=","=","!="]', '["SCHOOL","CLASS","STUDENT"]', 3),
('exam_item_count',   '涉及试题数',          'EXAM', 'NUMBER', '[">",">=","<","<=","=","!="]', '["SCHOOL","CLASS","STUDENT"]', 4),
('exam_score',        '涉及分数',            'EXAM', 'NUMBER', '[">",">=","<","<=","=","!="]', '["SCHOOL","CLASS","STUDENT"]', 5),
('exam_pass_status',  '达标状态',            'EXAM', 'ENUM',   '["=","!=","IN","NOT_IN"]',    '["SCHOOL","CLASS","STUDENT"]', 6),
('exam_pass_rate',    '达标占比',            'EXAM', 'NUMBER', '[">",">=","<","<=","=","!="]', '["SCHOOL","CLASS"]',           7),
-- 综合属性（学校、班级、学生，达标占比不含学生）
('overall_mastery',    '综合掌握度',         'COMPREHENSIVE', 'NUMBER', '[">",">=","<","<=","=","!="]', '["SCHOOL","CLASS","STUDENT"]', 1),
('overall_target',     '目标值',             'COMPREHENSIVE', 'NUMBER', '[">",">=","<","<=","=","!="]', '["SCHOOL","CLASS","STUDENT"]', 2),
('overall_reliability','可信度',             'COMPREHENSIVE', 'NUMBER', '[">",">=","<","<=","=","!="]', '["SCHOOL","CLASS","STUDENT"]', 3),
...
('overall_pass_status','达标状态',           'COMPREHENSIVE', 'ENUM',   '["=","!=","IN","NOT_IN"]',    '["SCHOOL","CLASS","STUDENT"]', 7),
('overall_pass_rate',  '达标占比',           'COMPREHENSIVE', 'NUMBER', '[">",">=","<","<=","=","!="]', '["SCHOOL","CLASS"]',           8);
